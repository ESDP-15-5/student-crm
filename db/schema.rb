...
ActiveRecord::Schema.define(version: 20160211101950) do
  ...
  add_index "course_element_materials", ["deleted_at"], name: "index_course_element_materials_on_deleted_at"
